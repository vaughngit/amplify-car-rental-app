...
export default function RentalCarUpdateForm(props) {
  ...
  const [rentalCarRecord, setRentalCarRecord] = React.useState(rentalCar);
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp
        ? await DataStore.query(RentalCar, idProp)
        : rentalCar;
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(
            RentalCar.copyOf(rentalCarRecord, (updated) => {
