...
export default function VideosUpdateForm(props) {
  const {
    id: idProp,
    videos,
    onSuccess,
  ...
  const [videosRecord, setVideosRecord] = React.useState(videos);
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp ? await DataStore.query(Videos, idProp) : videos;
      setVideosRecord(record);
    };
    queryData();
  }, [idProp, videos]);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(
            Videos.copyOf(videosRecord, (updated) => {
      ...
      {...getOverrideProps(overrides, "VideosUpdateForm")}
      {...rest}
    >
      <TextField
        label="Titl"
